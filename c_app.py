...
pink_shades = ['#FFB6C1', '#FF99AA', '#FF6699']
blue_shades = ['#87CEFA', '#66B2FF', '#3399FF']
purple_shades = ['#CBA3FF', '#9966FF', '#8A2BE2']
...
df_gender.plot(kind='bar', ax=ax, color=['#FFB6C1', '#87CEFA'], width=0.5, edgecolor='black')
...
if 'Date' in df.columns:
    ...
    sns.heatmap(heat_data, annot=True, fmt="d", cmap=cmap,
                annot_kws={'weight':'bold','fontsize':12, 'fontfamily':'Comic Sans MS'},
